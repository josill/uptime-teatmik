...
public class Entity : BaseEntityMetadata
{
    ...
    public virtual ICollection<EntityOwner> OwnedEntities { get; set; } = new List<EntityOwner>();
    public virtual ICollection<EntityOwner> EntityOwners { get; set; } = new List<EntityOwner>();
}